...
We can see that VIM and TBR gene expression is localized to two separate clusters. This is what we would expect in our data with some cells still at the progentor/ radial glail stage while others have begun to differate into neurons. We can also see that our data shows isofrm levle expresstion for each our genes. These isoforms TBR1 shows expresstion of
